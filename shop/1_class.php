...
<body>
   ...
   <div class="navbox">
    ...
    <!-- 內容 -->
    <h3>我們不只要給你魚吃，更要教你學會釣魚。</h3>
    <p>不用再補貨或是出去購買健康產品，自己的健康自己掌握，
        蔣家小館提供多種課程選擇，無論北中南蔣夫人皆有巡迴教室，
        讓你可以不用四處奔波，在家附近就可以得到最好的資源。
    </p>
    <h3>線上課程</h3>
    <p>我們提供線上的課程，如果時間不方便也可選擇採用線上課程，
        或是購買單一食譜，選擇自己喜歡的料理，自己製作喜歡的美食。
    </p>
    <!-- 底部 -->
