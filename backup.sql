...
CREATE TABLE `employee` (
  ...
  `employee_rank` enum('管理者','小幫手','檢視者','工程師','合作教室') NOT NULL,
...
INSERT INTO `employee` VALUES (1,'chiangmom','admin1234mom','Chiangmom','管理者','..\\material\\employee\\avatar (1).jpg'),(2,'chiangdad','admin1234dad','Chiangdad','管理者','..\\material\\employee\\avatar (2).jpg'),(3,'geoao','admin1234ao','Gaoao','小幫手','..\\material\\employee\\avatar (3).jpg'),(4,'gust','admin1234gust','Gust','檢視者','..\\material\\employee\\avatar (4).jpg'),(5,'chloe','admin1234chloe','Chloe','工程師','..\\material\\employee\\avatar (5).jpg'),(6,'classtest1','admin12341','ClassTest','合作教室','..\\material\\employee\\avatar (6).jpg'),(7,'classtest2','admin12342','ClassTest','合作教室','..\\material\\employee\\avatar (7).jpg');
...
-- Dump completed on 2023-09-10  0:11:50
